...
clf = RandomForestRegressor(random_state=40)
clf_random_cv = RandomizedSearchCV(clf, param_distributions={'n_estimators':[10, 30, 50], 'max_features':[1, 3, 5]}, cv=5, scoring='neg_root_mean_squared_error')
clf_random_cv.fit(train_X_ppr, train_y_ppr.ravel())

joblib.dump(clf_random_cv, "./model/m2_10000")
clf = joblib.load("./model/m2_10000")
